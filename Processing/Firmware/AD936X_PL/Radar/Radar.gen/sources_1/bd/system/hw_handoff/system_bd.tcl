...
proc create_root_design { parentCell } {
  ...
  set gpio_ctl [ create_bd_port -dir O -from 3 -to 0 -type data gpio_ctl ]
  set gpio_en_agc [ create_bd_port -dir O gpio_en_agc ]
  set gpio_i [ create_bd_port -dir I -from 63 -to 0 gpio_i ]
  set gpio_o [ create_bd_port -dir O -from 63 -to 0 gpio_o ]
  set gpio_status [ create_bd_port -dir I -from 7 -to 0 -type data gpio_status ]
  ...
  # Create instance: fastlock_hopper_0, and set properties
  set block_name fastlock_hopper
  set block_cell_name fastlock_hopper_0
  if { [catch {set fastlock_hopper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fastlock_hopper_0 eq "" } {
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  connect_bd_net -net fastlock_hopper_0_gpio_ctl [get_bd_ports gpio_ctl] [get_bd_pins fastlock_hopper_0/gpio_ctl] [get_bd_pins ila_0/probe0]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins fastlock_hopper_0/enable] [get_bd_pins xlconstant_0/dout]
