...
class fmcw(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, bb_chirp_period=(1e-3), center_freq=2.5e9, pilot_amplitude=.2, rx_gain=60, sdr_fs=int(50e6), subchirp_idx=0, tx_gain=50, usrp_string=""):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fmcw")
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/Users/levifarinas/Documents/SAR Research/Stitched/tx_chirp_{subchirp_idx}.wav',
            2,
            sdr_fs,
            blocks.FORMAT_WAV,
...
def argument_parser():
    ...
    parser.add_argument(
        "--sdr-fs", dest="sdr_fs", type=intx, default=int(50e6),
