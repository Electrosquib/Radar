...
class continuous_chirp(gr.top_block):

    def __init__(self, bb_chirp_period=(1e-3), center_freq=2.5e9, mask=0, pilot_amplitude=.2, rx_gain=.7, sdr_fs=int(4e6), subchirp_idx=0, tx_gain=1, usrp_string=""):
        ...
        self.uhd_usrp_source_0.set_bandwidth(sdr_fs, 0)
        ...
        self.uhd_usrp_sink_0.set_bandwidth(sdr_fs, 0)
        self.uhd_usrp_sink_0.set_normalized_gain(tx_gain, 0)
        self.blocks_wavfile_sink_1 = blocks.wavfile_sink(
            '/Users/levifarinas/Documents/SAR Research/Data/sweep.wav',
            5,
            sdr_fs,
            blocks.FORMAT_WAV,
        ...
        self.connect((self.blocks_complex_to_float_1_0, 1), (self.blocks_wavfile_sink_1, 4))
        self.connect((self.blocks_complex_to_float_1_0, 0), (self.blocks_wavfile_sink_1, 3))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.blocks_complex_to_float_1_0, 0))
    ...
    def set_sdr_fs(self, sdr_fs):
        ...
        self.uhd_usrp_sink_0.set_bandwidth(self.sdr_fs, 0)
        self.uhd_usrp_source_0.set_samp_rate(self.sdr_fs)
        self.uhd_usrp_source_0.set_bandwidth(self.sdr_fs, 0)
...
def argument_parser():
    ...
    parser.add_argument(
        "--rx-gain", dest="rx_gain", type=eng_float, default=eng_notation.num_to_str(float(.7)),
        help="Set rx_gain [default=%(default)r]")
    parser.add_argument(
        "--sdr-fs", dest="sdr_fs", type=intx, default=int(4e6),
    ...
    parser.add_argument(
        "--tx-gain", dest="tx_gain", type=eng_float, default=eng_notation.num_to_str(float(1)),
...
def main(top_block_cls=continuous_chirp, options=None):
    if options is None:
