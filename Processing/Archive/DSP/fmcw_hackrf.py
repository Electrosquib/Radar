...
class fmcw_hackrf(gr.top_block):

    def __init__(self, bb_chirp_period=(1e-3), center_freq=2.5e9, pilot_amplitude=.2, rx_gain=60, sdr_fs=int(10e6), subchirp_idx=0, tx_gain=50, usrp_string=""):
        ...
        self.blocks_wavfile_sink_1_1 = blocks.wavfile_sink(
            '/Users/levifarinas/Documents/SAR Research/Data/chirp.wav',
            2,
            sdr_fs,
            blocks.FORMAT_WAV,
        ...
        self.blocks_wavfile_sink_1_0 = blocks.wavfile_sink(
            '/Users/levifarinas/Documents/SAR Research/Data/pilot.wav',
            2,
            sdr_fs,
            blocks.FORMAT_WAV,
            blocks.FORMAT_PCM_16,
        ...
        self.blocks_wavfile_sink_1 = blocks.wavfile_sink(
            '/Users/levifarinas/Documents/SAR Research/Data/tx.wav',
            2,
            sdr_fs,
            blocks.FORMAT_WAV,
            blocks.FORMAT_PCM_16,
        ...
        self.connect((self.analog_frequency_modulator_fc_0, 0), (self.blocks_complex_to_float_1_1, 0))
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_complex_to_float_1_0, 0))
        ...
        self.connect((self.blocks_complex_to_float_1_0, 1), (self.blocks_wavfile_sink_1_0, 1))
        self.connect((self.blocks_complex_to_float_1_0, 0), (self.blocks_wavfile_sink_1_0, 0))
        self.connect((self.blocks_complex_to_float_1_1, 0), (self.blocks_wavfile_sink_1_1, 0))
        self.connect((self.blocks_complex_to_float_1_1, 1), (self.blocks_wavfile_sink_1_1, 1))
...
def main(top_block_cls=fmcw_hackrf, options=None):
    if options is None:
